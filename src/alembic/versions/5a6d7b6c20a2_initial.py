...
Revision ID: 5a6d7b6c20a2
Revises: 
Create Date: 2024-10-25 14:54:02.911736
...
def upgrade() -> None:
    ...
    sa.Column('continent', sa.String(length=50), server_default='Europe', nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.PrimaryKeyConstraint('id', 'continent'),
    sa.UniqueConstraint('id'),
    sa.UniqueConstraint('login', 'continent'),
